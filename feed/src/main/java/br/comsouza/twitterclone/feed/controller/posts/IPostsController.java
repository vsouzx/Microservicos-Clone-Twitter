...
public interface IPostsController {
    ...
    ResponseEntity<Void> retweetToggle(String originalTweet, String request, List<MultipartFile> attachment) throws Exception;
    ...
    ResponseEntity<Void> commentToggle(String originalTweet, String request, List<MultipartFile> attachment) throws Exception;
