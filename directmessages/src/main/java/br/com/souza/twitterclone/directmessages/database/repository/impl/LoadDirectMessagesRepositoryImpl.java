...
public class LoadDirectMessagesRepositoryImpl {
    ...
    public List<ChatsResponse> getAllChats(String sessionUserIdentifier) {
        ...
        sb.append("    LEFT JOIN chat_ignored_messages i  ");
        sb.append("		    ON i.chat_identifier = d.chat_identifier  ");
        sb.append("		    AND i.user_identifier = @sessionUserIdentifier  ");
        sb.append("		    AND i.message_identifier = d.identifier  ");
        sb.append("    WHERE (c.user_identifier_1 = @sessionUserIdentifier OR c.user_identifier_2 = @sessionUserIdentifier)  ");
        sb.append("	        AND i.message_identifier IS NULL ");
