...
public interface IUserInfosController {
    ...
    ResponseEntity<Void> updateProfilePhoto(MultipartFile request, Integer xPosition, Integer yPosition) throws Exception;
    ...
    ResponseEntity<Void> updateBackgroundPhoto(MultipartFile request, Integer xPosition, Integer yPosition) throws Exception;
