...
public class UsersRepositoryImpl {
    ...
    public List<UserDetailsByIdentifierResponse> findAllByUsername(String sessionUserIdentifier, String targetUsername, Integer page, Integer size){
        ...
        sb.append("				,(SELECT IIF(MAX(blocker_identifier) IS NULL, CONVERT(BIT, 0), CONVERT(BIT, 1))  ");
        ...
        sb.append(" ");
        sb.append("				,(SELECT IIF(MAX(blocked_identifier) IS NULL, CONVERT(BIT, 0), CONVERT(BIT, 1))  ");
        sb.append("				  FROM blocked_users ");
        sb.append("				  WHERE blocked_identifier = @sessionUser ");
        sb.append("					AND blocker_identifier = u.identifier) hasBlockedMe ");
        sb.append(" ");
        sb.append("				,(SELECT IIF(MAX(follower_identifier) IS NULL, CONVERT(BIT, 0), CONVERT(BIT, 1))  ");
        ...
        sb.append(" ");
        sb.append("				,(SELECT IIF(MAX(pending_follower_identifier) IS NULL, CONVERT(BIT, 0), CONVERT(BIT, 1))  ");
        ...
        sb.append(" ");
        sb.append("				,(SELECT IIF(MAX(followed_identifier) IS NULL, CONVERT(BIT, 0), CONVERT(BIT, 1))  ");
        sb.append("				  FROM users_follows ");
