...
public interface IUsersSearchService {
    ...
    List<UserPreviewResponse> getUserFollowsDetails(String sessionUserIdentifier, String targetUserIdentifier, String type, Integer page, Integer size) throws Exception;
